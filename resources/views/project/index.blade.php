...
<div class="container mt-5"><h1 class="text-center">Assign project to worker:</h1></div>
{{-- {{dd([$projects,$users])}} --}}
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="form-group row mt-3">
                <div class="col-sm-10">
                  <button type="submit" class="btn btn-primary mx-auto d-block " style="letter-spacing: 1px;">Assign job</button>
                </div>
              </div>
          </div>
        </div>
